...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto mt-5" style="max-width: 300px">
        <?= form_open('login', ['novalidate' => true]) ?>
        <h1 class="h3 mb-3 fw-normal">Login de Exemplo</h1>
        ...
        <?php if (isset($errors) && array_key_exists('default', $errors)) : ?>
