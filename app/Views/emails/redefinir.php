...
<body>
  <span class="preheader">Redefinção de Senha</span>
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="center">
                      ...
                      <p>Alguém solicitou alteração nas suas credenciais da conta PDV Acelerado. Se foi você, clique no link abaixo para redefinir sua senha.</p>
                          ...
                          <tr>
                            <td align="center">
                              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                  <tr>
                                    <td> <a href="<?= $link ?>" target="_blank">Redefinir senha</a> </td>
                                  </tr>
                                </tbody>
                              </table>
                            </td>
                      ...
                      <p>ou colando este link no navegador:</p>
                      <p style="color: #3498db"><?= $link ?></p>
                      <p>Se você não deseja redefinir suas credenciais, apenas ignore essa mensagem e nada será alterado.</p>
