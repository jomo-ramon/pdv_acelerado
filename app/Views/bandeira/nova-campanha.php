...
<div class="card">
    ...
    <div class="card-body">
        <?= form_open('/bandeira/campanha/store', ['id' => 'formAddCampanha', 'class' => 'needs-validation', 'novalidate' => true]) ?>
        ...
        <div class="mb-3">
            <select class="form-control select2" id="select-lojas" multiple aria-label="multiple select example"
                name="lojas[]" placeholder="Escolha as lojas participantes">
                <option>Escolha as lojas participantes</option>
            </select>
            <div id="lojasHelp" class="form-text">Ao deixar em branco todas as lojas da rede serão selecionadas.
            </div>
        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show p-2 pt-4 position-relative" id="tab12">
                                <?= form_open('/bandeira/produto/store', ['id' => 'formAddProduto', 'class' => 'needs-validation', 'novalidate' => true]) ?>
                                <div class="form-floating mb-3">
...
<script src="<?= base_url('assets/js/bandeiras/nova-campanha.js') ?>"></script>
<?= $this->endSection() ?>